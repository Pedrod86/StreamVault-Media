...
import { Home, Film, Tv, Radio, Sparkles, Search, Download, Settings, LayoutGrid, Library } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { to: '/server-libraries', label: 'Server Libraries', icon: Library },
